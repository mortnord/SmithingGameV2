...
public class GridController : MonoBehaviour
{
    ...
    {
        if (dwarf.GetComponent<DwarfScript>().Get_Direction() == 1) //W
        {
            target_pos = new Vector3Int(dwarfPos.x, dwarfPos.y + 1, 0);
        }
        else if (dwarf.GetComponent<DwarfScript>().Get_Direction() == 2) //A
        {
            target_pos = new Vector3Int(dwarfPos.x - 1, dwarfPos.y, 0);
        }
        else if (dwarf.GetComponent<DwarfScript>().Get_Direction() == 3) //D
        {
            target_pos = new Vector3Int(dwarfPos.x + 1, dwarfPos.y, 0);
        }
        else if (dwarf.GetComponent<DwarfScript>().Get_Direction() == 4) //S
        {
            target_pos = new Vector3Int(dwarfPos.x, dwarfPos.y - 1, 0);
        }
        return target_pos;
