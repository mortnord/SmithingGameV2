...
public class Energy : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Set_Position_Beers(); //Evnt øl / energibarer
    }
    ...
    public void Set_Position_Beers()
    {
    ...
    public void Change_sprite() //Denne sjekker om vi ska ha 1 eller 2 pickaxes. 
    {
        ...
        {
            Energy_Objects[last_object].GetComponent<Pickaxe>().Set_Sprite(Energy_Objects[last_object].GetComponent<Pickaxe>().spriteArray[1]);
        }
        else if(StaticData.Energy_mining_static > 0) //hvis vi har mer enn 0, men ikke ett oddetall skal 2 vises. 
        {
            Energy_Objects[last_object].GetComponent<Pickaxe>().Set_Sprite(Energy_Objects[last_object].GetComponent<Pickaxe>().spriteArray[0]);
        }
    }
}
