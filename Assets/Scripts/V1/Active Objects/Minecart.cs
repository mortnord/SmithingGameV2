...
public class Minecart : MonoBehaviour, IInteractor_Connector
{
    ...
    void Start()
    {
        ...
        Get_Ore_From_Below(); //Hent ore fra staticData. 
        position = transform.position;
    }
    private void Get_Ore_From_Below() //Lager malm i minecarten basert på kvaliteten i StaticData. 
    {
    ...
    {
        main_character.GetComponent<MainCharacterStateManager>().Set_Item_In_Inventory(list_of_ore[0]);
