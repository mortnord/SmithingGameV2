...
public class Furnace : MonoBehaviour, IInteractor_Connector, IData_Transfer
{
    ...
    {
        result = Handle_Quality(Find_Quality(main_character.GetComponent<DwarfScript>().Get_Item_In_Inventory()));
        if (result == true)
        {
            ...
            Ores_in_furnace.Add(main_character.GetComponent<DwarfScript>().Get_Item_In_Inventory());
